...
def get_trigger_mask(img_size, total_pieces, masked_pieces):#8
    div_num = sqrt(total_pieces)#4
    step = int(img_size // div_num)#8
    candidate_idx = random.sample(list(range(total_pieces)), k=masked_pieces) #[0, ..., 15] candidate: half
