...
class Poison_IMG_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        # idx = int(idx)
        # idx = self.poison_indices[int(ori_idx)]
        ...
        return img, label, poi

class IMG_Dataset(Dataset):
    def __init__(self, data_dir, label_path, transforms = None, num_classes = 10, shift = False, random_labels = False,
                 fixed_label = None, indices=None):
        """
        Args:
            data_dir: directory of the data
            label_path: path to data labels
        ...
        """
        self.dir = data_dir
        self.gt = torch.load(label_path)[:60] #TODO for 0.001 posion rate
    ...
    def update_transform(self, new_transforms):
